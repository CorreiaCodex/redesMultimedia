...
/////////////////////////////////////////////////////////////
        ...
        DIR *dir;
        struct dirent *lsdir;
        dir = opendir("/home/correia/Desktop/RM/RMv2.5/server2.5");
        int i = 0;
        char fileName[20];
...
//////////////////////////////////////////////////////////////////
        ...
        if(read(connfd, inmsg, BUFFERSIZE)<0){
        ...
        if(strcmp(file,"s")==0){
            //write(connfd,"Clips stopped, you can choose another one or type 'exit' to quit",strlen("Clips stopped, you can choose another one or type 'exit' to quit"));
            pthread_cancel(tid);
...
/////////////////////////////////////////////////////////////
        // VERIFICA SE O CLIENT ESCOLHEU UM VIDEO CORRETAMENTE
            ...
            if(dataFile==NULL){
                ...
                n = write(connfd,info,BUFFERSIZE);   //in non exitence case tell client
                //return 2;
            }else{
